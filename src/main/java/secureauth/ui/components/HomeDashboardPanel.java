...
public final class HomeDashboardPanel extends JPanel {
    ...
    private JPopupMenu createAppointmentsPopupMenu() {
        ...
        start.addActionListener(e -> updateSelectedAppointmentStatus(secureauth.model.AppointmentStatus.IN_PROGRESS.databaseValue()));
        finish.addActionListener(e -> updateSelectedAppointmentStatus(secureauth.model.AppointmentStatus.FINALIZED.databaseValue()));
        cancel.addActionListener(e -> updateSelectedAppointmentStatus(secureauth.model.AppointmentStatus.CANCELLED.databaseValue()));
