    ...
    public void loadConfigMetrics() {
        new SwingWorker<ConfigMetricsData, Void>() {
            ...
            protected ConfigMetricsData doInBackground() throws Exception {
                ...
                // Servicios más populares (por citas, usando capa de servicios sin SQL en Swing)
                var popularServices = new secureauth.service.enterprise.AppointmentService().findPopularServices(3);
                ...
                // Ingresos por categoría (usando capa de servicios sin SQL en Swing)
                var incomeList = salesService.loadIncomeByCategory(2);
